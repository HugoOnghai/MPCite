...
# from .core import find_out_of_date_doi_entries, update_existing_osti_record
# import os
...
#     with (
#         MongoClient() as doi_client
#     ):  # open the mongoclient outside of the for loop, is more efficient than opening and closing it repeatedly
...
#         osti_OOD_list = find_out_of_date_doi_entries(
#             real_client, doi_client, "mp_core_blue", "robocrys", "dois_test", "dois"
#         )
#         print(osti_OOD_list)
...
#         new_values = {
#             "description": "UPDATED ROBOCRYS DESCRIPTION: "
#             + next(
#                 real_client["mp_core_blue"]["robocrys"].find(
#                     {"material_id": material_id_to_update}, {"_id": 0, "description": 1}
#                 )
#             )["description"]
#         }
